	...
	private void setNumericObject(int parameterIndex, Object parameterObj, int targetSqlType, int scale) throws SQLException {
		...
		case Types.NUMERIC:
			...
			if (parameterAsNum instanceof BigDecimal) {
				...
				try {
					scaledBigDecimal = ((BigDecimal) parameterAsNum)
							.setScale(scale);
				...
				setBigDecimal(
						parameterIndex,
						new BigDecimal(
								(BigInteger) parameterAsNum,
								scale));
			} else {
				setBigDecimal(parameterIndex,
						new BigDecimal(parameterAsNum
								.doubleValue()));
			}
			...
			try {
					...
					case Types.TIMESTAMP:
						...
						if (parameterAsDate instanceof Timestamp) {
							setTimestamp(parameterIndex,
									(Timestamp) parameterAsDate);
						} else {
							setTimestamp(parameterIndex,
									new Timestamp(parameterAsDate
											.getTime()));
						}
				...
				case Types.TIME:
					...
					if (parameterObj instanceof String) {
						...
						setTime(parameterIndex, new Time(sdf.parse(
