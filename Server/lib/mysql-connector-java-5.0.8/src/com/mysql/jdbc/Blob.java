...
public class Blob implements java.sql.Blob, OutputStreamWatcher {
	...
	/**
	 * @see com.mysql.jdbc.Blob#setBinaryStream(long)
	 */
	...
	/**
	 * @see com.mysql.jdbc.Blob#setBytes(long, byte[])
	 */
	...
	/**
	 * @see com.mysql.jdbc.Blob#setBytes(long, byte[], int, int)
	 */
	...
	/**
	 * @see OutputStreamWatcher#streamClosed(byte[])
	 */
	...
	/**
	 * @see com.mysql.jdbc.Blob#truncate(long)
	 */
