...
public class CallableStatement extends PreparedStatement implements
	 ...
	 * 
	 * @throws java.sql.SQLException if we can't build the metadata.
	 */
		...
		if (numParameters > 0) {
			...
			if (hadOutputParams) {
				...
				try {
					...
					this.outputParameterResults = ((ResultSet) outParamRs)
							.copy();
	...
	/**
	 * @see java.sql.CallableStatement#setTime(String, java.sql.Time)
	 */
	...
	/**
	 * @see java.sql.CallableStatement#setTimestamp(String,
	 *      java.sql.Timestamp)
	 */
