...
class MysqlIO {
     ...
     *        timeout)
     *
     * @throws java.io.IOException if an IOException occurs during connect.
     * @throws java.sql.SQLException if a database access error occurs.
     */
    public MysqlIO(String host, int port, Properties props,
			String socketFactoryClassName, Connection conn,
     ...
     * 
     * @throws java.sql.SQLException if the network fails while skipping the
     * packet.
     */
     ...
     *
     * @throws java.sql.SQLException is the packet is an error packet
     */
     ...
     *
     * @throws java.sql.SQLException DOCUMENT ME!
     * @throws com.mysql.jdbc.CommunicationsException DOCUMENT ME!
     */
    ...
    */
     ...
     *
     * @throws java.sql.SQLException if an I/O error or SQL error occurs
     */
     ...
     *
     * @throws java.sql.SQLException if an error occurs while reading the rows
     */
    private final ResultSet readResultsForQueryOrUpdate(
        ...
        if (columnCount == 0) {
            ...
            ResultSet results = getResultSet(callingStatement,
    ...
    private ResultSet buildResultSetWithRows(
        Statement callingStatement, String catalog,
        Field[] fields, RowData rows, int resultSetType,
        ...
        case java.sql.ResultSet.CONCUR_READ_ONLY:
            rs = new ResultSet(catalog, fields, rows,
        ...
        case java.sql.ResultSet.CONCUR_UPDATABLE:
            rs = new UpdatableResultSet(catalog, fields, rows,
                    this.connection, callingStatement);

            break;

        default:
            return new ResultSet(catalog, fields, rows,
                this.connection, callingStatement);
        }
    ...
    private ResultSet buildResultSetWithUpdates(
        ...
        ResultSet updateRs = new ResultSet(updateCount,
     ...
     * @return DOCUMENT ME!
     *
     * @throws java.sql.SQLException if an error packet was received
     * @throws com.mysql.jdbc.CommunicationsException DOCUMENT ME!
     */
