...
public class DatabaseMetaData implements java.sql.DatabaseMetaData {
	...
	static ResultSet buildResultSet(Field[] fields,
			ArrayList rows, Connection c) throws SQLException {
	...
	private ResultSet buildResultSet(Field[] fields,
			ArrayList rows) throws SQLException {
	...
	public List extractForeignKeyForTable(ArrayList rows,
			ResultSet rs, String catalog) throws SQLException {
		byte[][] row = new byte[3][];
		row[0] = rs.getBytes(1);
	...
	/**
	 * @see com.mysql.jdbc.DatabaseMetaData#getAttributes(String, String, String, String)
	 */
	public ResultSet getAttributes(String arg0, String arg1,
	...
	/**
	 * @see com.mysql.jdbc.DatabaseMetaData#getDatabaseMajorVersion()
	 */
	...
	/**
	 * @see com.mysql.jdbc.DatabaseMetaData#getDatabaseMinorVersion()
	 */
	...
	/**
	 * @see com.mysql.jdbc.DatabaseMetaData#getJDBCMajorVersion()
	 */
	...
	/**
	 * @see com.mysql.jdbc.DatabaseMetaData#getJDBCMinorVersion()
	 */
	...
	protected ResultSet getProceduresAndOrFunctions(String catalog,
			String schemaPattern, String procedureNamePattern,
	...
	/**
	 * @see com.mysql.jdbc.DatabaseMetaData#getResultSetHoldability()
	 */
	...
	public ResultSet getSchemas() throws SQLException {
		...
		fields[0] = new Field("", "TABLE_SCHEM", Types.CHAR, 0);
		fields[1] = new Field("", "TABLE_CATALOG", Types.CHAR, 0);
	...
	/**
	 * @see com.mysql.jdbc.DatabaseMetaData#getSQLStateType()
	 */
	...
	/**
	 * @see com.mysql.jdbc.DatabaseMetaData#getSuperTables(String, String, String)
	 */
	public ResultSet getSuperTables(String arg0, String arg1,
	...
	/**
	 * @see com.mysql.jdbc.DatabaseMetaData#getSuperTypes(String, String, String)
	 */
	public ResultSet getSuperTypes(String arg0, String arg1,
			String arg2) throws SQLException {
		Field[] fields = new Field[6];
		fields[0] = new Field("", "TABLE_CAT", Types.CHAR, 32);
		fields[1] = new Field("", "TABLE_SCHEM", Types.CHAR, 32);
	...
	public ResultSet getTables(String catalog, String schemaPattern,
		...
		fields[0] = new Field("", "TABLE_CAT", Types.VARCHAR, 255);
		fields[1] = new Field("", "TABLE_SCHEM", Types.VARCHAR, 0);
		fields[2] = new Field("", "TABLE_NAME", Types.VARCHAR, 255);
		fields[3] = new Field("", "TABLE_TYPE", Types.VARCHAR, 5);
		fields[4] = new Field("", "REMARKS", Types.VARCHAR, 0);
	...
	public ResultSet getTypeInfo() throws SQLException {
		...
		rowVal = new byte[18][];
		rowVal[0] = s2b("BIT");
		rowVal[1] = Integer.toString(Types.BIT).getBytes();
		...
		rowVal[1] = Integer.toString(Types.TINYINT).getBytes();
		...
		rowVal = new byte[18][];
		rowVal[0] = s2b("BIGINT");
		rowVal[1] = Integer.toString(Types.BIGINT).getBytes();
		...
		rowVal[1] = Integer.toString(Types.LONGVARBINARY).getBytes();
		...
		rowVal[1] = Integer.toString(Types.VARBINARY).getBytes();
		...
		rowVal = new byte[18][];
		rowVal[0] = s2b("BINARY");
		rowVal[1] = Integer.toString(Types.BINARY).getBytes();
		...
		rowVal[1] = Integer.toString(Types.LONGVARCHAR).getBytes();
		...
		rowVal = new byte[18][];
		rowVal[0] = s2b("CHAR");
		rowVal[1] = Integer.toString(Types.CHAR).getBytes();
		...
		rowVal[1] = Integer.toString(Types.NUMERIC).getBytes();
		...
		rowVal[1] = Integer.toString(Types.DECIMAL).getBytes();
		...
		rowVal[1] = Integer.toString(Types.INTEGER).getBytes();
		...
		rowVal[1] = Integer.toString(Types.SMALLINT).getBytes();
		...
		rowVal = new byte[18][];
		rowVal[0] = s2b("FLOAT");
		rowVal[1] = Integer.toString(Types.REAL).getBytes();
		...
		rowVal = new byte[18][];
		rowVal[0] = s2b("DOUBLE");
		rowVal[1] = Integer.toString(Types.DOUBLE).getBytes();
		...
		rowVal[1] = Integer.toString(Types.VARCHAR).getBytes();
		...
		rowVal = new byte[18][];
		rowVal[0] = s2b("DATE");
		rowVal[1] = Integer.toString(Types.DATE).getBytes();
		...
		rowVal = new byte[18][];
		rowVal[0] = s2b("TIME");
		rowVal[1] = Integer.toString(Types.TIME).getBytes();
		...
		rowVal[1] = Integer.toString(Types.TIMESTAMP).getBytes();
	...
	/**
	 * @see com.mysql.jdbc.DatabaseMetaData#locatorsUpdateCopy()
	 */
	...
	/**
	 * @see com.mysql.jdbc.DatabaseMetaData#supportsMultipleOpenResults()
	 */
	...
	/**
	 * @see com.mysql.jdbc.DatabaseMetaData#supportsNamedParameters()
	 */
	 ...
	 * @throws java.sql.SQLException
	 *             if a database access error occurs
	 * @see com.mysql.jdbc.Connection#disableAutoClose
	 */
	...
	/**
	 * @see com.mysql.jdbc.DatabaseMetaData#supportsResultSetHoldability(int)
	 */
	...
	/**
	 * @see com.mysql.jdbc.DatabaseMetaData#supportsSavepoints()
	 */
	...
	/**
	 * @see com.mysql.jdbc.DatabaseMetaData#supportsStatementPooling()
	 */
