...
public class ServerPreparedStatement extends PreparedStatement {
	 ...
	 * 
	 * @see com.mysql.jdbc.Statement#addBatch
	 */
	...
	/**
	 * @see PreparedStatement#executeInternal(int,
	 *      Buffer, boolean, boolean)
	 */
	...
	/**
	 * @see PreparedStatement#fillSendPacket()
	 */
	...
	/**
	 * @see PreparedStatement#fillSendPacket(byte,
	...
	/**
	 * @see PreparedStatement#getBytes(int)
	 */
	...
	/**
	 * @see PreparedStatement#isNull(int)
	 */
	 ...
	 * @throws java.sql.SQLException
	 */
	private ResultSet serverExecute(int maxRowsToRetrieve,
		...
		synchronized (this.connection.getMutex()) {
			...
			try {
				...
				ResultSet rs = mysql.readAllResults(this,
	 ...
	 *             if a database access error occurs
	 */
	public void setTimeInternal(int parameterIndex, Time x,
