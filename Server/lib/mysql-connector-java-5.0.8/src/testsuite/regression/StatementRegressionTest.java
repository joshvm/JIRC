...
public class StatementRegressionTest extends BaseTestCase {
	...
	public void testBug3620() throws SQLException {
		...
		try {
			...
			Timestamp ts = new Timestamp(pointInTime
					.getTime().getTime());
	...
	public void testBug4119() throws Exception {
		try {
			...
			pStmt.setString(1, "0");
			pStmt.setString(2, "0");
			pStmt.setTimestamp(3, new Timestamp(System
					.currentTimeMillis()));
			pStmt.setString(4, "ABC");
			pStmt.setString(5, "DEF");
			pStmt.setString(6, "AA");
			pStmt.setTimestamp(7, new Timestamp(System
					.currentTimeMillis()));
	...
	public void testServerPrepStmtAndDate() throws Exception {
		try {
			...
			Date dt = new Date(102, 1, 2); // Note, this represents the
			// date 2002-02-02
	...
	public void testBug20650() throws Exception {
		...
		try {
			closedConn = getConnectionWithProps((Properties)null);
